...
class FinanceReportsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mix = controller.revenueBySource();
    final monthlyTrend = controller.monthlyRevenueTrend();
    final topServices = controller.topServices();
    final recentInvoices = controller.invoices.take(8).toList();
    ...
    final cardWidth = isWide ? 250.0 : 220.0;
      ...
      child: Column(
        ...
        children: [
          ...
          if (isWide)
            ...
            SectionCard(
              title: 'الاتجاه الشهري للإيرادات',
              subtitle: 'ملخص آخر 6 أشهر من الأداء المالي الحالي داخل التطبيق.',
              child: MiniBarChart(
                points: monthlyTrend,
                color: AppTheme.success,
              ),
            ...
            SectionCard(
              title: 'توزيع الإيراد حسب القسم',
              subtitle: 'مقارنة بين مساهمة الاستقبال والتحاليل في الإيراد.',
              child: _FinanceMixCard(mix: mix),
            ),
          ],
          const SizedBox(height: 24),
          if (isWide)
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: SectionCard(
                    ...
                    subtitle: 'سجل تفصيلي لآخر الفواتير التي دخلت في التقارير.',
                    child: Column(
            ...
            SectionCard(
              ...
              child: Column(
                children: recentInvoices
                    .map((invoice) => _FinanceInvoiceRow(invoice: invoice))
                    .toList(),
              ),
            ),
          ],
